label start:
    ...
    extend """
        ...
        Szczerze mówiąc żałuję że nie ciągnąłem go dalej.
        Chilowe wyjście z roli herosa uświadomiło mi, jak bardzo przytłaczająca jest atmosfera tego miejsca.
    ...
    Dziewczyna1 "Dobrze zrobię to. Jest to prokurator WARDĘGA."
    "aż przeszły mnie ciarki."
    Konopski "Od kiedy niby Sylwester Wardęga jest budzącym postrach prokuratorem"
    Dziewczyna1 " aż przeszły mnie ciarki!"
    "nie wypowiadaj tego imienia na daremno!"
    Konopski "Moje pytanie absolutnie zaliczoło się do kategorii nie na daremno... Ale mniejsza o to, wróćmy do poprzedniego pytania."
    ...
    Dziewczyna1 "Uważa je za opus magnum sądownictwa."
    Konopski "Więc może powinien zostać obrońcą?"
    Dziewczyna1 "Jego ulubione powiedzenie to..."
    extends "każdy kij ma dwa końce!"
    Dziewczyna1 "ooooo, creepy!"
