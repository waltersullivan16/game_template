label sad_poczatek:
    ...
    Poza tym, pomijając absurd całej tej sytuacji, czy przypadkiem nie jestem oskarżonym, a nie obrońcą?"
    Lexiu "Zgadza się, ale żaden obrońca z urzędu nie zdecydował się na podjęcie tej sprawy. Wszyscy skapitulowali zaraz po usłyszeniu nazwiska prokuratora.
    ...
    Lexiu "Konopski, to nie jest czas i miejsce na zgrywanie ornitologa!
    ...
    NIE
    Jest tu tyle nadużyć, że nawet nie wiem od czego miałbym zacząć..."
    ...
    Proszę stronę oskarżającą o zabranie głosu."
    Wardega "To dla mnie zaszczyt wysoki sądzie.
    ...
    Wardgea "Nazywam się Sylwester Wardęga. Dla jednych druid sprawiedliwości.
    ...
    Wardęga "Ja sam lubię myśleć o sobie jako o drugim Johnniem Cochranie.
    To adwokat O.J.Simsona ty intelektualna amebo."
    ...
    Wardega "W dniu dzisiejszym proszę zwracać się do mnie per 'panie druidzie'."
    Konopski "[Ok, jakkolwiek, możemy już przejść dalej?]"
    ...
    Wardęga "Nie, kiedyś napisał to jakiś koleś na forum miłośników imagestocka."
    Konopski "[Ale to twoje oficjalne motto, tak...?]"
    Lexiu "Aaaaaa, już łapię."
    "W sensie że batuta to też kijek, tak?"
    Wardęga "Dokładnie tak Konopski. wiedziałem że będziesz miał problem z rozszyfrowaniem meandrów poezji."
    Konopski "[Czy jest jeszcze jakikolwiek sens, żebym cokolwiek komentował...?]"
    Wardega "No ale dość już tego pajacowania Konopski, to nie czas i miejsce na czcze pogaduszki."
    Konopski "...
    Mea culpa, od teraz będę starał się powstrzymać od bezsensownych monologów..."
    Wardega "Dobrze, przejdźmy wreszcie do "
    "Zgromadziliśmy się tu dzisiaj, aby należycie ukarać obecnego tu oskarżonego, nazywanego też chwilowo obrońcą. To pozbawiony jakiegokolwiek kompasu moralnego młodociany bandyta, który nawet w tym
    krytycznym dla siebie momencie nie potrafi opanować patologicznego braku szacunku wobec starszych. Życie innych ma dla niego tyle znaczenia co babki z piasku, które dla wlasnego widzimisie
    można zrównać z ziemią. Jeśli ten pączkujący jeszcze młodzian osiągnął tak zaawansowany stan deprawacji, to czego możemy się spodziewać, gdy ten drań osiągnie pełnoletność?
    Gdyby tego było mało, ten partacz nie jest zeznajomiony z pojęciem reaserchu i jego pożałowania godne materiały, co w połączeniu z wynaturzoną naturę, stanowi zagrożenie dla niewinnych obywateli.
    Nikogo nie powinno dziwić, że to nieposkromione łajdactwo doprowadziło do tragedii. Ohydne kłamstwa wymierzone w kierunku bogu ducha winnego mężczyzny, nazywanego też chwilowo sędzią, konsekwencją czego
    jest znaczące pogorszenie się stanu psychicznego sympatycznego jegomościa. Wnoszę prośbę o jego krótki komentarz w tej kwestii."
    Lexiu "Ten bestialski czyn zasługuje na dożywocie."
    Konopski "[No to tyle jeśli chodzi o niezawisłość sędziowską.]"
